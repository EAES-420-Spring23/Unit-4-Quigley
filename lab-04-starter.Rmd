...
the year, day, and deaths variables can be coerced from doubles into integers without losing information. 

### Exercise 9

The years would be not be ordered chronologically on the graph. 
